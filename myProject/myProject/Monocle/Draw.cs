...
namespace Monocle
{
    public static class Draw
    {
        ...
        internal static void Initialize(GraphicsDevice graphicsDevice)
        {
            ...
            // DefaultFont precisa do asset Content/Monocle/MonocleDefault.xnb.
            // Sem ele, geometria (Rect/Line/etc) ainda funciona; só DrawString falha.
            try
            {
            ...
            {
                Console.WriteLine("Draw: DefaultFont nao carregada (" + e.Message + "). Texto desativado.");
            }
        ...
        {
            MTexture texture = new MTexture(VirtualContent.CreateTexture("debug-pixel", 3, 3, Color.White));
            Pixel = new MTexture(texture, 1, 1, 1, 1);
            Particle = new MTexture(texture, 1, 1, 1, 1);
        }
        ...
        {
            SpriteBatch.Draw(Pixel.Texture.Texture, start, Pixel.ClipRect, color, angle, Vector2.Zero, new Vector2(length, 1), SpriteEffects.None, 0f);
        }

        public static void LineAngle(Vector2 start, float angle, float length, Color color, float thickness)
        {
            SpriteBatch.Draw(Pixel.Texture.Texture, start, Pixel.ClipRect, color, angle, new Vector2(0, 0.5f), new Vector2(length, thickness), SpriteEffects.None, 0f);
        }
        ...
        {
            Draw.SpriteBatch.DrawString(font, text, position.Floored(), color);
        }
        ...
        {
            Draw.SpriteBatch.DrawString(font, text, position.Floored(), color, rotation, origin, scale, SpriteEffects.None, 0f);
        }
        ...
        public static void TextJustified(SpriteFont font, string text, Vector2 position, Color color, Vector2 justify)
        {
            ...
            Draw.SpriteBatch.DrawString(font, text, position.Floored(), color, 0, origin, 1, SpriteEffects.None, 0);
        }
        ...
        public static void TextJustified(SpriteFont font, string text, Vector2 position, Color color, float scale, Vector2 justify)
        {
            ...
            Draw.SpriteBatch.DrawString(font, text, position.Floored(), color, 0, origin, scale, SpriteEffects.None, 0);
        }
        ...
        {
            Text(font, text, position, color, font.MeasureString(text) * 0.5f, Vector2.One * scale, 0);
        }
        ...
        public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, float scale)
        {
            ...
            for (int i = -1; i < 2; i++)
                for (int j = -1; j < 2; j++)
                    if (i != 0 || j != 0)
                        Draw.SpriteBatch.DrawString(font, text, position.Floored() + new Vector2(i, j), Color.Black, 0, origin, scale, SpriteEffects.None, 0);
        ...
        public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, Color outlineColor)
        {
            ...
            for (int i = -1; i < 2; i++)
                for (int j = -1; j < 2; j++)
                    if (i != 0 || j != 0)
                        Draw.SpriteBatch.DrawString(font, text, position.Floored() + new Vector2(i, j), outlineColor, 0, origin, 1, SpriteEffects.None, 0);
        ...
        public static void OutlineTextCentered(SpriteFont font, string text, Vector2 position, Color color, Color outlineColor, float scale)
        {
            ...
            for (int i = -1; i < 2; i++)
                for (int j = -1; j < 2; j++)
                    if (i != 0 || j != 0)
                        Draw.SpriteBatch.DrawString(font, text, position.Floored() + new Vector2(i, j), outlineColor, 0, origin, scale, SpriteEffects.None, 0);
        ...
        public static void SineTextureH(MTexture tex, Vector2 position, Vector2 origin, Vector2 scale, float rotation, Color color, SpriteEffects effects, float sineCounter, float amplitude = 2f, int sliceSize = 2, float sliceAdd = MathHelper.PiOver4)
        {
            ...
            while (clip.X < tex.ClipRect.X + tex.ClipRect.Width)
            {
                ...
                Draw.SpriteBatch.Draw(tex.Texture.Texture, position, clip, color, rotation, origin - add, scale, effects, 0);
        ...
        public static void SineTextureV(MTexture tex, Vector2 position, Vector2 origin, Vector2 scale, float rotation, Color color, SpriteEffects effects, float sineCounter, float amplitude = 2f, int sliceSize = 2, float sliceAdd = MathHelper.PiOver4)
        {
            position = position.Floored();
        ...
        public static void TextureBannerV(MTexture tex, Vector2 position, Vector2 origin, Vector2 scale, float rotation, Color color, SpriteEffects effects, float sineCounter, float amplitude = 2f, int sliceSize = 2, float sliceAdd = MathHelper.PiOver4)
        {
            position = position.Floored();

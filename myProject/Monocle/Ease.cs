...
namespace Monocle
{
    public static class Ease
    {
        ...
        private const float PI2 = 1.5707964f;
        ...
        public static readonly Easer SineIn = (float t) => { return -(float)Math.Cos(PI2 * t) + 1; };
        public static readonly Easer SineOut = (float t) => { return (float)Math.Sin(PI2 * t); };
        public static readonly Easer SineInOut = (float t) => { return -(float)Math.Cos(PI * t) / 2f + .5f; };

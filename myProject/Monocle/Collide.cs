...
namespace Monocle
{
    public static class Collide
    {
        ...
        #region Entity vs Point / Line / Rect
        ...
        public static bool CircleToLine(Vector2 cPosition, float cRadius, Vector2 lineFrom, Vector2 lineTo)
        {
            return Vector2.DistanceSquared(cPosition, Calc.ClosestPointOnLine(lineFrom, lineTo, cPosition)) < cRadius * cRadius;
        }
